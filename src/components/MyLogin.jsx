    ...
    return (
        <View className='flex-1 justify-center items-center bg-gray-900 p-5'>
            ...
            <TextInput 
                ...
                className='w-full h-12 bg-gray-800 rounded text-white px-4 mb-4'
                value={email}
            ...
            <TouchableOpacity className='mt-4'>
                <Text className="text-center text-indigo-300">Forgot Password</Text>
            </TouchableOpacity>
            <View className='flex-row mt-6 justify-center'>
                <Text className='text-center text-indigo-300'>Don't have an account? </Text>
                <TouchableOpacity>
                    <Text className="text-indigo-300">Signup</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
